...
export interface EnsureFamilyAccountRequest {
	accountId?: string;
	syncSubscription?: boolean;
	subscription?: Record<string, unknown>;
}

export const ensureFamilyAccountForUser = async (
	uid: string,
	data: EnsureFamilyAccountRequest = {},
	knownUserData?: Record<string, unknown>,
) => {
...
export const ensureFamilyAccount = functions.https.onCall(
	async (data: EnsureFamilyAccountRequest, context) => {
		...
		return ensureFamilyAccountForUser(context.auth.uid, data);
	},
);
