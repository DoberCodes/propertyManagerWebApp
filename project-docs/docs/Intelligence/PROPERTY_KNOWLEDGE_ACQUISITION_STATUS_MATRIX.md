...
| Inspection reports | Partial, expanded | Recognized text-based home-inspection PDFs and DOCX files use staged section understanding before producing controlled equipment, specification, observation, and explicit recommendation-task candidates. Structured PDF and DOCX maintenance reports continue through the visit interpreter. | Required before any record changes. | Reviewed unscheduled tasks, controlled equipment matches or additions, equipment specifications, expandable report observations, and document provenance. A completed Maintenance Event is proposed only when the source clearly supplies dated performed work. | The deterministic inspection interpreter requires a usable text layer and recognizable headings. Arbitrary layouts, scanned/image-only reports, licensed-inspector interpretation, and condition diagnosis are not current support. Report observations remain source-attributed context. |
