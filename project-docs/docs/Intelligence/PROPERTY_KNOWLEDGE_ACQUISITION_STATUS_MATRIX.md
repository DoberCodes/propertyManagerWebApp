...
| PDF maintenance service reports | Current, structured reports | Canonical PDF upload, layout-aware embedded-text extraction, visit metadata, completed work, status observations, recommended task candidates, and controlled equipment reconciliation through the shared service-report interpreter. | Required before creating or updating Maintenance Events, Tasks, or Equipment. | A source-linked Maintenance Event, reviewed recommendation tasks, matched or newly approved equipment records, technician attribution, and dated visit observations. | Deterministic parsing requires a usable embedded text layer and recognizable labeled fields or tables. Scanned/image-only reports still require rendered-page OCR. |
...
| DOCX maintenance service reports | Current, structured reports | Canonical DOCX upload, backend paragraph and table extraction, visit metadata, completed work, status observations, recommended task candidates, and controlled equipment reconciliation. | Required before creating or updating Maintenance Events, Tasks, or Equipment. | A source-linked Maintenance Event, reviewed recommendation tasks, matched or newly approved equipment records, technician attribution, and dated visit observations. | Deterministic parsing targets structured service reports with labeled visit fields, task/status tables, and explicit next steps. Arbitrary prose reports, legacy `.doc`, handwritten content, and image-only content inside DOCX files are not interpreted. |
| Manuals | Stored only | Canonical upload, category, assignment, and source-document links. General document scanning is disabled. | No extracted changes are proposed. | Source document provenance and user-managed links only. | Purpose-built model, maintenance-schedule, parts, and troubleshooting extraction is deferred because general document heuristics produce unreliable results on long manuals. |
| Warranties | Stored only | Canonical upload, category, assignment, and source-document links. General document scanning is disabled. | No extracted changes are proposed. | Source document provenance and user-managed links only. | Purpose-built coverage, exclusions, claim instructions, and registration-deadline extraction is deferred. |
...
| Inspection reports | Partial, expanded | Recognized text-based home-inspection PDFs and DOCX files use staged section understanding before producing controlled equipment, specification, observation, and explicit recommendation-task candidates. Inspection v4 preserves exact task-to-equipment and supply-to-equipment candidates, including multi-equipment actions. Structured PDF and DOCX maintenance reports continue through the visit interpreter. | Required before any record changes. Equipment details and proposed relationships remain editable in review. | Reviewed unscheduled tasks, controlled equipment matches or additions, equipment specifications, property-owned Supplies with reviewed Equipment links, expandable report observations, and document provenance. A completed Maintenance Event is proposed only when the source clearly supplies dated performed work. | The deterministic inspection interpreter requires a usable text layer and recognizable headings. Arbitrary layouts, scanned/image-only reports, licensed-inspector interpretation, and condition diagnosis are not current support. Relative timing remains source evidence until the reviewer chooses a date or ASAP. Report observations remain source-attributed context. |
