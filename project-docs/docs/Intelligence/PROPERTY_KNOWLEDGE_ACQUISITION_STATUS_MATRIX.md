...
| Inspection reports | Partial | Classified by document name or type. Structured PDF and DOCX maintenance reports can produce visit, observation, recommendation-task, and equipment-reconciliation suggestions; other formats may produce only OCR or metadata suggestions. | Required before any record changes. | Maintenance History context, reviewed tasks, controlled equipment matches or additions, contractor context, and document provenance. | General inspection narratives, arbitrary room-by-room formats, licensed-inspector interpretation, and condition diagnosis are not current support. Reported statuses remain provider-attributed observations. |
