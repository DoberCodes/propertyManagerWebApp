...
- Risky scripts detected: 31
- Risky scripts without dry-run signal: 20
...
| scripts/maintenanceHistoryWriteContainment.test.cjs | delete | no |
...
- scripts/maintenanceHistoryWriteContainment.test.cjs
