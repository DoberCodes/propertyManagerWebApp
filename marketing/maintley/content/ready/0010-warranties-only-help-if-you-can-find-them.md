...
- checklist: Use a calm, practical visual tied to home records, documents, maintenance history, or a simple before-and-after comparison.
...
1. A warranty only helps if you can find it when you need it.
2. The hardest part of using a warranty is often finding the record.
3. Warranty information should stay close to the thing it protects.
4. A receipt in an inbox is not the same as a useful home record.
5. The best time to organize warranty information is before something breaks.
...
- project-docs/docs/Product/PRODUCT_DIRECTION.md: The Property Setup Assistant should help users create useful records without overwhelming them.
- project-docs/docs/UX/UX_LANGUAGE_GUIDE.md: Expanded content should explain what Maintley found in the saved records and, when useful, show affected systems or tasks.
- project-docs/docs/Intelligence/PROPERTY_INTELLIGENCE.md: It should help users understand not only what information exists, but what actions would provide the greatest value next.
