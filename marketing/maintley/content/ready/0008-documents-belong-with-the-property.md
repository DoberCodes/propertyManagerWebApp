...
- screenshot: Use a calm, practical visual tied to home records, documents, maintenance history, or a simple before-and-after comparison.
...
1. The right document is most useful when it is connected to the right part of the home.
2. Home documents should not disappear into inboxes and drawers.
3. A warranty is easier to use when it stays with the property record.
4. Receipts, manuals, and warranties are part of the home story.
5. Documents become more useful when they are not scattered.
...
- project-docs/docs/UX/UX_LANGUAGE_GUIDE.md: Property Scan should be described as an explainable review of saved property records.
- project-docs/docs/Intelligence/PROPERTY_INTELLIGENCE.md: The system should help users make progress rather than remind them how incomplete their records are.
