		...
		<>
			...
			<Wrapper>
				...
				<CTASection>
					...
					<CTADescription>
						Maintley began with a simple problem: important home details disappear
						over time. Start building a property history you can use later.
					</CTADescription>
					<CTAButtons>
						<CTAButton onClick={() => navigate('/register')}>Start Free</CTAButton>
						<CTASecondary onClick={() => navigate('/login')}>Sign In</CTASecondary>
					</CTAButtons>
				</CTASection>
					...
					<FooterContent>
						...
						<FooterLinks aria-label='Footer navigation'>
							...
							<FooterGroup>
								...
								<FooterLink as='a' href='/resources/home-maintenance-checklist/'>
									Home Maintenance Checklist
								</FooterLink>
								<FooterLink as='a' href='/resources/seasonal-home-maintenance-schedule/'>
									Seasonal Maintenance Schedule
								</FooterLink>
								<FooterLink as='a' href='/resources/'>All Articles</FooterLink>
							</FooterGroup>
							<FooterGroup>
